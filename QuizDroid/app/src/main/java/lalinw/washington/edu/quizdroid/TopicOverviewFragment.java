...
public class TopicOverviewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_topic_overview, container, false);
        Button beginQuiz = (Button)v.findViewById(R.id.quiz_start);
        beginQuiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i("FRAGMENT", "beginQuiz clicked");
